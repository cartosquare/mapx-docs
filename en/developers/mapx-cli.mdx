...
5. `mapx view live --session <id>` — print a live, shareable URL of the project.
...
mapx view live --session <id>                      # live view URL (SSE-synced)
mapx view live --session <id> --open               # open it in the local browser
